...
/**
 * GET route
 * grabs the users relationships (found in Activities Check In)
 */
router.get("/", (req, res) => {
  // GET route code here
...
/**
 * POST route
 * inserts the new relationship into the relationship table
 */
router.post("/", (req, res) => {
  ...
  const values = [
    req.body.name,
    req.body.relationship_to_user,
    req.body.relationship_icon,
    req.body.user_id,
  ];
